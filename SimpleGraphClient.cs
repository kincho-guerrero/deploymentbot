...
namespace Microsoft.BotBuilderSamples
{
    ...
    public class SimpleGraphClient
    {
        ...
        public async Task<Application> RegisterNewApp(string AppName, string SignInAudience)
        {
                ...
                return  await graphClient.Applications
                    .Request()
                    .AddAsync(application);
        }


        public async Task<PasswordCredential> CreateNewPassword(string AppId)
        {
                var graphClient = GetAuthenticatedClient();

                var passwordCredential = new PasswordCredential
                {
                    DisplayName = "FAQ Plus App"
                };

               return await graphClient.Applications[AppId]
